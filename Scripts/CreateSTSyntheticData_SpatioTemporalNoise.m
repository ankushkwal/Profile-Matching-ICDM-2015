function [] = CreateSTSyntheticData_SpatioTemporalNoise(tile_name,lake_id,NP,run_num,SCmax,TCmax)
...
GT = reshape(GT,N,T);
lake_id = [lake_id '_STNP_' num2str(NP) '_SC_' num2str(SCmax) '_TC_' num2str(TCmax) '_RR_' num2str(run_num)]
sr = 1;er = R;sc = 1;ec = C;
locs = ones(N,1);
