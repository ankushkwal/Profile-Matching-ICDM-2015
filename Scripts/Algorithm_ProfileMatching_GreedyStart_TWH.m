function [] = Algorithm_ProfileMatching_GreedyStart_TWH(input_name)
% This algorithm uses TWH criteria to break the ties between locations assigned to same elevation

data_dir = './../Data/';
output_name = ['PMG_TWH_'  input_name]; % profile matching with greedy start (PMG) and uses Total Water Heuristic to break ties (TWH)
